...
class _$UserDocumentReference
  ...
  Future<void> update({
    Object? balances = _sentinel,
  }) async {
    final json = {
      if (balances != _sentinel) "balances": balances as List<String>,
    };
...
class _$UserQuery extends QueryReference<UserQuerySnapshot>
  ...
  UserQuery orderByBalances({
    ...
    var query = reference.orderBy('balances', descending: descending);
